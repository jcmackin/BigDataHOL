...
Visual Studio Code opens, along with a web page and a dialog box about Internet Explorer settings.  
3. Close other open windows so that only Visual Studio Code is open.
...
## Exercise 5: xxxxx
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTU4MTU5MDkzMl19
-->