...
```
The SELECT statement below, limits the data selected to a 6 month period of the entire year of data available, based on the latest review date (last_review). The WHERE clause restricts the listings ito those reviewed between June 1, 2017 and December 31, 2017.
...
## Exercise 5: xxxxx
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTk2MDcxMTg0NV19
-->