...
The DSVM contains the tools we need, but these tools are missing some components by default.  Before you can perform U-SQL queries in our source code editor Visual Studio Code, you will need to download and install an additional Visual Studio component, Azure Data Lake Tools, and additional script dependencies.
...
1.	Create a new folder named AzureHOLs in any convenient location on your system. You will use this folder to store about 50MB of project files.
...
## Exercise 5: xxxxx
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzQxMDE3Njk1XX0=
-->